...
(function (fn) {
    ...
    $('[data-image-cover]:not(.cover)').each(function (i, el){
        ...
        $el.addClass('d-none').after(
            $('<span>').addClass('image-cover').css('backgroundImage', "url(/static/" + $el.attr('src') + ")" )
        );
    });
    ...
    $('[data-image-horizontal]:not(.horizontal)').each(function (i, el){
        var $el = $(el);
        $el.addClass('d-none').after(
            $('<span>').addClass('image-horizontal').css('backgroundImage', "url(/static/" + $el.attr('src') + ")" )
        );
    });
    ...
    initMap = function (){
        ...
        $('.gmap').each(function(i, el){
            ...
            new google.maps.Marker({
              position: mark,
              map: map,
              icon: data.marker || "/static/images/parts/map-marker.png"
            });
